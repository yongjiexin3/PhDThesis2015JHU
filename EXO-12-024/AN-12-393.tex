...
\hypersetup{%
  ...
  pdftitle={Search for heavy resonances in the W/Z-tagged dijet mass
...
\input{analysis.tex}
\input{N-subjettiness.tex}
\input{data_and_mc_samples.tex}
\input{trigger.tex}
\input{data_mc_comparisons.tex}
\input{WtagSF.tex}
\input{signal.tex}
