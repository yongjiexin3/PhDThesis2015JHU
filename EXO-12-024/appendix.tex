...
%\begin{figure}[htbp]
%\centering
%\includegraphics[width=0.48\textwidth]{figs/sig-pile-up/jetMassPileUp.pdf}
%\includegraphics[width=0.48\textwidth]{figs/sig-pile-up/jetMassPileUpLog.pdf}
...
%\begin{figure}[htbp]
%\centering
%\includegraphics[width=0.48\textwidth]{figs/sig-pile-up/massDropPileUp.pdf}
%\includegraphics[width=0.48\textwidth]{figs/sig-pile-up/massDropPileUpLog.pdf}
...
%\begin{figure}[htbp]
%\centering
%\includegraphics[width=0.88\textwidth]{figs/sig-pile-up/DijetMassPileUp.pdf}
...
%\begin{figure*}[[h!tpb]]
%\centering
%\includegraphics[width=0.48\textwidth]{figs/taggingpt/pt0_eff.pdf}
%\includegraphics[width=0.48\textwidth]{figs/taggingpt/pt1_eff.pdf}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/data2012_v3_deta_2mtag_2mdtag_deta.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/data2012_v3_deta_1mtag_0mdtag_deta.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/data2012_v3_deta_2mtag_2mdtag_0mtag_deta.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/data2012_v2_njets_2mtag_2mdtag_njets.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/data2012_v3_njetsCA8_2mtag_2mdtag_njetsCA8.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/noMassrebin.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/singleMassNoDroprebin.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/singleTagExclusiverebin.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/doubleMassNoDroprebin.pdf}
%\end{center}
%\caption{Dijet mass distribution}
%\label{fig:cd}
%\end{figure}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/doubleMassSingleDroprebin.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/doubleMassDoubleDroprebin.pdf}
%\end{center}
%\caption{Dijet mass distribution}
%\label{fig:ef}
%\end{figure}
...
%\begin{figure}[htb]
%\begin{center} 
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/RSGWWherwig_0xMass_limit_obsexp.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/RSGWWherwig_1xMass0xMassdrop_limit_obsexp.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center} 
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/RSGWWherwig_1xMass1xMassdrop_limit_obsexp.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/RSGWWherwig_2xMass0xMassdrop_limit_obsexp.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/RSGWWherwig_2xMass1xMassdrop_limit_obsexp.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/VVCheck/RSGWWherwig_2Tag_limit_obsexp.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_WW_channel5_m0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_WW_channel3_m1mg0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_WW_channel4_m1mg1.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_WW_channel0_m2mg0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_WW_channel1_m2mg1.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_WW_channel2_m2mg2.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_ZZ_channel5_m0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_ZZ_channel3_m1mg0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_ZZ_channel4_m1mg1.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_ZZ_channel0_m2mg0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_ZZ_channel1_m2mg1.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/pvalue_ZZ_channel2_m2mg2.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/brazilianFlag_acc_WW_m2mg2.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/brazilianFlag_acc_WW_m2mg1.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/brazilianFlag_acc_WW_m2mg0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/brazilianFlag_acc_WW_m1mg1.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/brazilianFlag_acc_WW_m1mg0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/appendix/brazilianFlag_acc_WW_0m.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/MassAndDrop/DataMassAndDrop0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/MassAndDrop/DataMassAndDrop1.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/MassAndDrop/QCDHerwigMassAndDrop0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/MassAndDrop/QCDHerwigMassAndDrop1.pdf}
%\end{center}
...
%\begin{figure}[htb]
%\begin{center}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/MassAndDrop/SignalHerwig1TeVMassAndDrop0.pdf}
%\includegraphics[width=0.48\textwidth,angle=0]{figs/MassAndDrop/SignalHerwig1TeVMassAndDrop1.pdf}
%\end{center}
