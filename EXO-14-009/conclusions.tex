...
\begin{table}[htb]
\begin{center}
  \topcaption{Summary of observed limits on resonance masses at 95\% CL
    and their expected values, assuming a null
    hypothesis. The analysis is sensitive to resonances heavier than 1\TeV.\label{table:results}}
\begin{tabular}{ ccc}
\hline
